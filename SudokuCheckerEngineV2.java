public class SudokuCheckerEngineV2 {
   ...
   public static void main(String[] args) {
      ...
      SudokuBoard board1 = new SudokuBoard("Sudoku2/empty.sdk");
      ...
      SudokuBoard board2 = new SudokuBoard("Sudoku2/valid-incomplete.sdk");
      ...
      SudokuBoard board3 = new SudokuBoard("Sudoku2/valid-complete.sdk");
      ...
      SudokuBoard board4 = new SudokuBoard("Sudoku2/dirty-data.sdk");
      ...
      SudokuBoard board5 = new SudokuBoard("Sudoku2/row-violation.sdk");
      ...
      SudokuBoard board6 = new SudokuBoard("Sudoku2/col-violation.sdk");
      ...
      SudokuBoard board7 = new SudokuBoard("Sudoku2/row-and-col-violation.sdk");
      ...
      SudokuBoard board8 = new SudokuBoard("Sudoku2/grid-violation.sdk");
